...
public class PostDetailsActivity extends AppCompatActivity {
    ...
    private void populatePost(DocumentSnapshot doc){
        ...
        // Hiển thị thời gian đăng bằng tiếng Việt
        ...
        if(ts != null){
            ...
            if(diff < 60_000){
                ...
                timeText = (diff / 60_000) + " phút trước";
            } else if(diff < 86_400_000){
                timeText = (diff / 3_600_000) + " giờ trước";
            } else {
                timeText = (diff / 86_400_000) + " ngày trước";
            }
            tvPostTime.setText(timeText);
        }
                    ...
                    for(DocumentSnapshot d : snaps){
                        ...
                        db.collection("users").document(c.getAuthorUserId())
                                ...
                                .addOnSuccessListener(u -> {
                                    ...
                                    c.setAuthorName(u.getString("fullName"));
    ...
    private void toggleLike(){
        ...
        if(isLiked){
            ...
            likeDocRef.delete().addOnSuccessListener(a ->
                    postRef.update("likeCount", FieldValue.increment(-1))
            );
        }
    }
    ...
    private void updateLikeUI(){
        btnLike.setImageResource(
                isLiked ? R.drawable.ic_favorite_red : R.drawable.ic_favorite_base
        );
    }
